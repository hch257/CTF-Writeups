...
from utils import ModP, b64_to_point, commitment, mod_hash, point_to_b64, point_to_bytes
...
from pwn import *
import json
from chall_pow import solve_challenge
p = remote('54.180.139.83', 13337)


p.recvuntil("with:\n")
t1 = p.recvline().decode('utf-8')
chall = t1.split(" ")[9].strip('\n')
solution = solve_challenge(chall)
print(solution)
p.sendline(solution)
p.recv()
